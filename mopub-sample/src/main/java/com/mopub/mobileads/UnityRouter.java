...
public class UnityRouter {
    ...
    private static IUnityAdsListener wrappedListener;

    static void initWrappedListener() {
        if (wrappedListener == null) {
            IUnityAdsListener listener = UnityAds.getListener();
            // Quick check incase it is called more than once or some weird null
            // bullshit happens.
            if (listener != sUnityAdsListener) {
                wrappedListener = listener;
                // Unity ads has already been initialized, so we set our own
                // UnityRouter as the listener, so we can route events between
                // MoPub and Unity
                UnityAds.setListener(sUnityAdsListener);
                // Do not initialize again, or else there will be an error.
            }
        }
    }
    ...
    private static class UnityAdsListener implements IUnityAdsExtendedListener {
        ...
        public void onUnityAdsReady(String placementId) {
            ...
            if (wrappedListener != null) {
                wrappedListener.onUnityAdsReady(placementId);
            }
        }
        ...
        public void onUnityAdsStart(String placementId) {
            ...
            } else if (wrappedListener != null) {
                wrappedListener.onUnityAdsStart(placementId);
            }
        }
        ...
        public void onUnityAdsFinish(String placementId, UnityAds.FinishState finishState) {
            ...
            if (listener != null) {
                ...
                wrappedListener.onUnityAdsFinish(placementId, finishState);
            }
        }
        ...
        public void onUnityAdsClick(String placementId) {
            ...
            if (listener != null) {
                ...
                if (wrappedListener != null && wrappedListener instanceof IUnityAdsExtendedListener) {
                    ((IUnityAdsExtendedListener)wrappedListener).onUnityAdsClick(placementId);
                }
            }
        }
        ...
        public void onUnityAdsError(UnityAds.UnityAdsError unityAdsError, String message) {
            ...
            if (wrappedListener != null) {
                wrappedListener.onUnityAdsError(unityAdsError, message);
            }
        }
    }
